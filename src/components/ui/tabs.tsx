...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-ti-ctrl items-center justify-center rounded-md border border-border/70 bg-muted p-1 text-muted-foreground shadow-ti-sm",
      className
    )}
    {...props}
  />
