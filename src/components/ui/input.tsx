  ...
  ({ className, type, step, onBlur, onChange, min, ...props }, ref) => {
    ...
    return (
      <input
        ...
        min={normalizedMin}
        className={cn(
          "flex h-ti-ctrl w-full rounded-md border border-input bg-card px-3 py-2 text-sm shadow-ti-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground/70 focus-visible:bg-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        ref={ref}
