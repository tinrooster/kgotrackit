/**
 * INTERNAL demo seed — full detail for in-house / trusted builds only.
 * For customer-facing deployments use `seedData.public.ts` (selected when
 * `VITE_DEMO_SEED_PROFILE` is unset or `public`).
 *
...
export const DEMO_SEED_SOURCE_INTERNAL: DemoSeedSourceData = {
